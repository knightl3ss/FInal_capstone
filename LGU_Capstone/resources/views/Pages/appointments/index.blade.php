...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#" class="text-muted">Appointment</a></li>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <a href="{{ route('appointment.form') }}" class="text-decoration-none">
                <div class="card h-100 border-0 shadow-sm hover-shadow transition-all">
                    <div class="card-body d-flex align-items-center p-4">
                        <div class="flex-shrink-0 me-3 bg-light rounded-circle p-3 d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                        ...
                        <div>
                            <h3 class="card-title fs-5 fw-bold text-dark mb-1">Appointment Form</h3>
                            <p class="card-text text-muted mb-0">Access and manage appointment forms and documents</p>
                        </div>
                        <div class="ms-auto">
                            <i class="fas fa-chevron-right text-muted"></i>
                        </div>
